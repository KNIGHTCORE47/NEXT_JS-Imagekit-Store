...
import { IMAGE_VARIANTS } from "@/models/products.models"
...
export default function OrdersPage() {
    ...
    useEffect(() => {
        ...
        // NOTE - Fetch oders when the component mounts and user is a registered user
                    ...
                    orders.map((order) => {
                        ...
                        return (
                            <div
                                ...
                                className="card bg-base shadow-xl"
                            >
                                <div
                                    className="card-body"
                                >
                                        ...
                                        <div className="flex-grow">
                                            ...
                                            >
                                                <div>
                                                    ...
                                                    <div
                                                        className="space-y-1 text-base-content/70"
                                                    >
                                                        <p>
                                                        ...
                                                        <p>
                                                            License Type: {" "}
                                                            <span className="capitalize">{order.variant.license}</span>
                                                        </p>
